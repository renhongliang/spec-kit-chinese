...
description: 创建针对 Slack 优化的动画 GIF 的知识和工具。提供约束、验证工具和动画概念。当用户请求为 Slack 创建动画 GIF 时使用，例如"为我制作一个 X 做 Y 的 GIF 用于 Slack"。
license: Complete terms in LICENSE.txt
---

# Slack GIF 创建器

一个工具包，提供用于创建针对 Slack 优化的动画 GIF 的工具和知识。
...
**关于用户上传的说明**：此技能不包括预构建的图形，但如果用户上传图像，使用 PIL 加载和处理它 - 根据他们的请求解释他们是想直接使用还是仅作为灵感。
